...
local user_opts = {
    ...
    -- Netflix-like UI customizations
    theme = 'dark',             -- dark/light theme
    seekbarheight = 4,          -- height of the seekbar in pixels
    seekbarcolor = '255/55/55', -- color of the seekbar (R/G/B format)
    titlefontsize = 24,         -- title font size
    buttonsize = 32,            -- size of control buttons
    layout = 'bottom',          -- position of the control bar (bottom/top)
}
